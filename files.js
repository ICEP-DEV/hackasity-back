...
router.post('/judge/slot', (req,res) => {
    const {slot_id,judge_name,start_time,length,end_time,date,link,Admin_id} = req.body;

    mysqlConnection.query("insert into judgeslot set ?",{slot_id:slot_id,judge_name:judge_name,start_time:start_time,length:length,end_time:end_time,date:date,link:link,Admin_id:Admin_id},(error, results) =>{
        if(error){
            console.log(error);
        }else{
            res.json({
...
router.post('/hacker/slot', (req,res) => {
    const {slot_id,group_name,start_time,length,end_time,date,link,Admin_id} = req.body;

    mysqlConnection.query("insert into hackerslot set ?",{group_name:group_name,start_time:start_time,length:length,end_time:end_time,date:date,link:link,Admin_id:Admin_id},(error, results) =>{
        if(error){
            console.log(error);
        }else{
            res.json({
